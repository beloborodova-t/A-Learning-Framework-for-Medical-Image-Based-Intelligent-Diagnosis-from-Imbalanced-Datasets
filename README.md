...
The extracted and generated features are passed to train a CNN model to classify acne severity. 
### Step 6: Model evaluation
Model evaluation is implemented on validation data.  
